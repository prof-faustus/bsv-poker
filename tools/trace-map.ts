...
export const TRACE_MAP: Readonly<Record<string, Trace>> = {
  ...
  'REQ-NET-004': { files: ['apps/indexer-go/indexer/indexer.go', 'packages/app-services/src/transcript.ts', 'packages/adapters/src/transaction-graph.ts', 'docs/adr/0005-indexer-is-a-projection-not-an-adjudicator.md'], tests: ['apps/indexer-go/indexer/indexer_test.go', 'packages/app-services/test/transcript-legality.test.ts', 'packages/adapters/test/transaction-graph.test.ts'] },
  ...
  'REQ-CRYPTO-010': { files: ['packages/crypto-mentalpoker/src/realct.ts', 'packages/app-services/src/mp-shuffle.ts', 'packages/app-services/src/key-lifecycle.ts', 'docs/KEY-LIFECYCLE.md'], tests: ['packages/crypto-mentalpoker/test/realct.test.ts', 'packages/app-services/test/key-lifecycle.test.ts'] },
  ...
  'REQ-APP-053': { files: ['apps/client-web/src/screens/connect.ts'], tests: ['tests/web-interaction-rules.test.ts'] },
  'REQ-APP-042': { files: ['apps/client-web/src/app.ts'], tests: ['tests/web-interaction-rules.test.ts'] },
  'REQ-UI-002': { files: ['apps/client-web/src/app.ts'], tests: ['tests/web-interaction-rules.test.ts'] },
  ...
  'REQ-APP-241': { files: ['packages/adapters/src/bonded-channel.ts'], tests: ['tools/microbet-e2e.ts'] },
  'REQ-APP-242': { files: ['packages/adapters/src/bonded-channel.ts'], tests: ['tools/microbet-e2e.ts'] },
  ...
  'REQ-APP-020': { files: ['apps/client-desktop/native/main.c', 'apps/client-desktop/native/lifecycle.c'], tests: ['apps/client-desktop/native/test-lifecycle.c'] },
  'REQ-APP-021': { files: ['apps/client-desktop/native/lifecycle.c', 'apps/client-desktop/native/main.c'], tests: ['apps/client-desktop/native/test-lifecycle.c'] },
  'REQ-APP-022': { files: ['apps/client-desktop/native/lifecycle.c'], tests: ['apps/client-desktop/native/test-lifecycle.c'] },
  'REQ-APP-024': { files: ['apps/client-desktop/native/lifecycle.c'], tests: ['apps/client-desktop/native/test-lifecycle.c'] },
  'REQ-APP-026': { files: ['apps/client-desktop/native/lifecycle.c'], tests: ['apps/client-desktop/native/test-lifecycle.c'] },
  'REQ-APP-027': { files: ['apps/client-desktop/native/lifecycle.c', 'apps/client-desktop/native/main.c'], tests: ['apps/client-desktop/native/test-lifecycle.c'] },
  'REQ-APP-028': { files: ['apps/client-desktop/native/lifecycle.c'], tests: ['apps/client-desktop/native/test-lifecycle.c'] },
  ...
  'REQ-APP-043': { files: ['packages/adapters/src/regtest-node.ts', 'packages/adapters/src/real-node.ts'], tests: ['tools/node-e2e.ts'] },
  ...
  'REQ-APP-094': { files: ['apps/client-desktop/native/main.c'], tests: ['apps/client-desktop/verify-desktop.ts'] },
