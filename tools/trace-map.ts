...
export const TRACE_MAP: Readonly<Record<string, Trace>> = {
  ...
  'REQ-DATA-002': { files: ['packages/app-services/src/transcript.ts', 'packages/sdk/src/table.ts'], tests: ['packages/sdk/test/table.test.ts'] },
  'REQ-DATA-003': { files: ['packages/sdk/src/table.ts'], tests: ['packages/sdk/test/table.test.ts'] },
  'REQ-DATA-004': { files: ['packages/adapters/src/real-va.ts'], tests: ['packages/adapters/test/conformance.test.ts'] },
